...
#create_generated_clock -name clk50 -source [get_ports clk_ref_p] -divide_by 4 [get_pins clk_divide[1]/Q]
#set_clock_sense -positive clk_divide[1]_i_1/O
...
#create_clock -name clk156 -period 6.400 [get_pins xgbaser_gt_wrapper_inst/clk156_bufg_inst/O]
#create_clock -name dclk -period 12.800 [get_pins xgbaser_gt_wrapper_inst/dclk_bufg_inst/O]
###create_clock -name refclk -period 6.400 [get_pins xgphy_refclk_ibuf/O]
...
set_property LOC GTHE2_CHANNEL_X1Y12 [get_cells inst/xge_sub_i/axi_10g_ethernet_0/ten_gig_eth_pcs_pma/inst/ten_gig_eth_pcs_pma_block_i/gt0_gtwizard_10gbaser_init_i/gt0_gtwizard_10gbaser_i/gt0_gtwizard_10gbaser_i/gthe2_i]
...
create_clock -name xphy_rxusrclkout0 -period 3.103 [get_pins inst/xge_sub_i/axi_10g_ethernet_0/ten_gig_eth_pcs_pma/inst/ten_gig_eth_pcs_pma_block_i/gt0_gtwizard_10gbaser_multi_gt_i/gt0_gtwizard_gth_10gbaser_i/gthe2_i/]
create_clock -name xphy_txusrclkout0 -period 3.103 [get_pins inst/xge_sub_i/axi_10g_ethernet_0/ten_gig_eth_pcs_pma/inst/ten_gig_eth_pcs_pma_block_i/gt0_gtwizard_10gbaser_multi_gt_i/gt0_gtwizard_gth_10gbaser_i/gthe2_i/TXOUTCLK]
...
##  -group [get_clocks -include_generated_clocks mcb_sys_clk] \
...
#set_clock_groups -name async_userclk2_dclk -asynchronous \
#    -group [get_clocks  userclk2] \
