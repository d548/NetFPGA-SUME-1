...
#set_property -name xsim.more_options -value {-testplusarg TESTNAME=basic_test} -objects [get_filesets sim]
#set_property runtime {} [get_filesets sim]
#  set_property XSIM.TCLBATCH ../../../../misc/xsim_wave.tcl [get_filesets sim_1]
# Default to MTI
#set_property target_simulator ModelSim [current_project]
# MTI settings
#set_property runtime {} [get_filesets sim]
#set_property -name modelsim.vlog_more_options -value +acc -objects [get_filesets sim]
#set_property -name modelsim.vsim_more_options -value {+notimingchecks +TESTNAME=basic_test -GSIM_COLLISION_CHECK=NONE } -objects [get_filesets sim]
#set_property compxlib.compiled_library_dir {} [current_project]
#set_property modelsim.custom_udo "./misc/wave.do" [get_filesets sim]
# Generate the IPs
#generate_target {synthesis simulation} [get_ips]
#  generate_target example [get_files *mig_axi_mm_dual.xci]
 # set_property include_dirs { ../tb ../tb/dsport ../tb/include ../source/gen_chk project_1/xt_connectivity_trd.srcs/sources_1/ip/mig_axi_mm_dual/mig_axi_mm_dual/example_design/sim} [get_filesets sim]
